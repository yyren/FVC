...
$pypath ${script_dir}/testing_randomover.py \
$seed $mutype $pcode $balance_strategy $ratio_test $software \
1>${logpath}/${seed}_${balance_strategy}_${ratio_test}_${timestamp}.log \
2>${logpath}/${seed}_${balance_strategy}_${ratio_test}_${timestamp}.err
